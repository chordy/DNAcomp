...
def gen_lgat(typ,num,cdomain):
    ...
    if typ==1: #and gate
        ...
        s4=cg+cdomain[4]+cal+alpha+cal+cdomain[2]+cal+alpha+cal+cdomain[3]+cg #o=1
        ...
        s1=rec.rev_comp(rs1)
        s2=cg+cdomain[4]+cal+alpha+cal+cdomain[2]+cal+alpha+cal+cdomain[3]+cg
